<template>
  <div class="max-w-4xl mx-auto">
    ...
    <div class="flex mb-10 gap-4">
      <div class="bg-rick-3 px-2 py-1 rounded-md text-sky-900 font-bold">{{location.dimension}}</div>
      <div class="bg-rick-2 px-2 py-1 rounded-md text-sky-900 font-bold">{{location.type}}</div>
